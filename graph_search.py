...
def graph_search(
    ...
    print("Frontier initial: ")
    print(frontier)
    while True:
        if frontier.is_empty():
            return (False, action_set, len(initial_state.extract_plan()), (time.time() - start_time))
        ...
        for action in possible_actions:
            ...
            if (frontier.contains(possible_frontier_node) == False) and possible_frontier_node not in expanded:
                frontier.add(possible_frontier_node)
